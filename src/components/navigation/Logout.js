...
export const Logout = () => {
  const onLogout = async () => {
    let { splinterURL } = window.$CANOPY.getSharedConfig().canopyConfig;
    let token = JSON.parse(window.sessionStorage.getItem('CANOPY_USER')).token;
  ...
  return (
    <button className="Logout" title="logout" onClick={onLogout} >
